...
- 进行中的步 / 检查点：**步⑪ CP11.2b.3c 真正只读 Codex query responder**。CP11.2a/CP11.2a.1 用户文件资产与嵌套树身份已落 `c077cd2`/`3c4c9b4`；
  CP11.2b.1–2 鉴权耐久控制入口已落 `10215db`，CP11.2b.3a/b 动态预算、机械优先级与目标版本控制已落 `7f4fd73`/`2dfa653`（最新全量 992）。步①–⑩已完成；步⑪ CP11.1 已完成，CP11.2b.3c–d/CP11.3/CP11.4 继续。
