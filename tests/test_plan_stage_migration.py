...
def test_0011_preserves_completed_idea_chain_and_deepens_shared_stage_authority(
    tmp_path: Path,
) -> None:
    ...
    _upgrade_to_revision(database, "0011_plan_stage")
...
def test_0011_plan_owner_tables_bind_all_durable_acceptance_boundaries(
    tmp_path: Path,
) -> None:
