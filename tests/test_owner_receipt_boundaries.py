...
def test_lost_rm_custody_preserves_the_accepted_empty_quest_and_blocks_downstream(
    ...
    try:
        ...
        assert runtime.owners.research_graph.query_snapshot().facts == {
            ...
            "reasoning_outcome_count": 0,
            "reasoning_rejection_count": 0,
            "reasoning_scientific_outcome_count": 0,
            "reasoning_scientific_rejection_count": 0,
            "autonomous_question_count": 0,
            "question_anchor_count": 0,
            "graph_presence_fact_count": 0,
            "question_research_state_fact_count": 0,
            "formal_plan_count": 0,
