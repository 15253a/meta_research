...
def test_existing_0012_data_upgrades_to_one_durable_harness_run_model(
    tmp_path: Path,
) -> None:
    data_root = prepare_data_root(tmp_path / "upgrade-from-0012")
    ...
    with sqlite3.connect(data_root.database) as connection:
        ...
        assert version == ("0013_semantic_mcp_harness",)
